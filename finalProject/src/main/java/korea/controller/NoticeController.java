...
public class NoticeController {
	...
	public ModelAndView noticeWrite(NoticeDTO dto) {
		...
		String goURL = res > 0 ? "noticeListAdmin.do" : "noticeWrite.do";
	...
	public ModelAndView noticeUpdate(int noticeIdx, String title, String content) {
		...
		String goURL = res > 0 ? "noticeListAdmin.do" : "noticeUpdate.do?idx=" + noticeIdx;
	...
	public ModelAndView noticeDelete(@RequestParam("idx") int idx) {
		...
		String goURL = res > 0 ? "noticeListAdmin.do" : "noticeContent.do?idx=" + idx;
