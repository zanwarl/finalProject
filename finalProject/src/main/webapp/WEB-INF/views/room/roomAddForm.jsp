...
<%@ include file="../header.jsp" %>
      <article class="container">
        ...
        <div class="col-md-6 col-md-offset-3">
          <form role="form" name="roomadd.do" action="imageUploadForm.do" method="post">
          <input type="hidden" name="useridx" value="${useridx}"><br>
		    ...
		    <div class="form-group">
		      ...
		      <select class="form-control" id="sel1" name="rtype">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="roomname" name="roomname" placeholder="숙소이름">
            </div>
            <div class="form-group">
              <label for="roomprice">숙소가격</label>
              <input type="text" class="form-control" id="roomprice" name="roomprice" placeholder="숙소가격">
            </div>
             <div class="form-group">
              <label for="nodate">안되는날짜</label>
              <input type="text" class="form-control" id="datepicker" name="nodate" placeholder="안되는날짜" readonly="readonly">
            </div>
             <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input type="number" class="form-control" id="maxcount" name="maxcount" placeholder="최대인원">
            </div>
            <div class="form-group">
		...
		<script>
            ...
            <div class="form-group text-center">
              <button type="submit" class="btn btn-info">다음페이지로<i class="fa fa-check spaceLeft"></i></button>
              <button type="button" class="btn btn-warning" onclick="goList()">등록취소<i class="fa fa-times spaceLeft"></i></button>
            </div>
          </form>
        </div>
</article>
